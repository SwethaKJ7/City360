...
<head>
	...
	<body class="theme-bg log-screen" style="background-image:url(assets/img/banner-log.png);">
	
		<section class="log-wrapper">
			<div class="container">
				<div class="col-md-6 col-md-push-6">
					<h3 class="log-title">Corporate LogIn</h3>
						...
						<div class="form-group">
							...
							<div class="row">
								<div class="col-md-6 col-sm-6">
									...
									<input type="number" class="form-control" id="Phone_no" name="phone_no" placeholder="Phone_no" required>
								</div>
                                                             <div class="col-md-6 col-sm-6">
